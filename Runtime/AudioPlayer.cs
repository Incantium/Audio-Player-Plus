...
namespace Incantium.Audio
{
    ...
    internal sealed class AudioPlayer : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("The inputs to the audio player to which it listens.")]
        ...
        /// <summary>
        /// Method to subscribe itself to the inputs.
        /// </summary>
        private void OnEnable() => input.player = this;

        /// <summary>
        /// Method to unsubscribe itself to the inputs.
        /// </summary>
        private void OnDisable() => input.player = null;
        ...
        /// <seealso cref="Stop"/>
        internal void Play(float fadeSeconds, FadeType type) => Play(music, fadeSeconds, type);
        ...
        /// <param name="type">How to fade the audio clip between each other.</param>
        /// <seealso cref="Stop"/>
        internal void Play(MusicClip music, float fadeSeconds, FadeType type)
        {
        ...
        /// </summary>
        /// <param name="music">The audio clip to play.</param>
        internal void PlaySFX(MusicClip music) => sfx.PlayOneShot(music.clip, music.volume);
        ...
        internal void Stop(float fadeSeconds = 0) => tracks.Peek().Stop(fadeSeconds);
        
        /// <summary>
        /// Method to pause the audio player.
        /// </summary>
        /// <seealso cref="Resume"/>
        internal void Pause() => tracks.Peek().Pause();

        /// <summary>
        /// Method to resume the audio player.
        /// </summary>
        /// <seealso cref="Pause"/>
        internal void Resume() => tracks.Peek().Resume();
